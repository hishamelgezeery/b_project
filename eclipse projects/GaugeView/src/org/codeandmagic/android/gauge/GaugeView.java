...
public class GaugeView extends View {
    ...
    public static final float TEXT_VALUE_SIZE = 0.4f;
    ...
    public Paint getDefaultFacePaint() {
        final Paint paint = new Paint(Paint.ANTI_ALIAS_FLAG);
        paint.setShader(new RadialGradient(0.2f, 0.2f, mFaceRect.width() / 2, new int[]{Color.rgb(255, 255, 255), Color.rgb(255, 255, 255),
